...
bn,be,bc = utils.get_3arrs(df['B_NEC'])
bn_mov_ave = utils.move_average(bn,window=50*20,center=True,min_periods=1)
...
plot(df.index.values,bn_disturb,df['Latitude'].values,df_aux['QDLat'].values,df_aux['MLT'].values)
