...
if not BACH_MODE:
    trace_dir = r"G:\master\pyaw\scripts\results\aw_cases\archive\trace_points\pkl\12738"  # modify
    trace_fns = get_pkl_filenames(trace_dir)

    path = r"V:\aw\swarm\vires\measurements\SW_OPER_MAGA_HR_1B\SW_OPER_MAGA_HR_1B_12834_20160307T224621_20160308T001954.pkl"  # modify
    ...
    for trace_dir_name_pair in trace_dir_name_pairs:
        ...
        for pkl_path in pkl_paths:
            if trace_dir_name not in pkl_path:
                continue
