...
def plot_for_paper(datetimes,b1,b2,b3,orbit_number,if_save=False,save_dir= r"G:\note\毕业论文\images"):
    ...
    plt.suptitle(f"Three components of Disturb Magnetic Field in NEC Frame\nOrbit Number is {orbit_number}, From {st} to {et}")
...
for orbit_num,file_path_measurement, file_path_igrf,file_path_aux in zip(
    ...
    plot_for_paper(datetimes=df_measurement.index.values,b1=delta_B_E,b2=delta_B_N,b3=delta_B_C,orbit_number=orbit_num,if_save=True)
    print("end plot")
