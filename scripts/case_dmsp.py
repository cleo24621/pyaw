...
fig, axes = plot_multi_panel(
    ...
    figsize=(10, 14),
    figure_title="Alfven Wave Case: SwarmA from 20160311T064700 to 20160311T064900",
...
# --- dynamic region ---
st_dy = np.datetime64("2014-01-01T02:34:00")
et_dy = np.datetime64("2014-01-01T02:35:00")
t_mask = (datetimes >= st_dy) & (datetimes <= et_dy)
datetimes_dy = datetimes[t_mask]
delta_B_E_dy = delta_B_E[t_mask]
...
frequencies_psd_dy, Pxx_delta_B_E_dy_psd = delta_B_E_dy_psd.get_psd()
_, Pxx_E_north_dy_psd = E_north_dy_psd.get_psd()
...
delta_B_E_sta = delta_B_E[t_mask]
...
frequencies_psd_sta, Pxx_delta_B_E_sta_psd = delta_B_E_sta_psd.get_psd()
...
eb_ratio_psd_dy = (
    (Pxx_E_north_dy_psd / Pxx_delta_B_E_dy_psd) * 1e-3 * 1e9
)  # transform unit
...
plot_defs[0][0] = {
    ...
    "linewidth": 1.8,
    "labels": [r"$\Delta_{B_{East}}$", r"$E_{North}$"],
...
plot_defs[0][1] = {
    "plot_type": "line",
    "x_data": datetimes_dy,
    "y_data_list": [E_north_dy, delta_B_E_dy],
    "labels": [r"$\Delta_{B_{East}}$", r"$E_{North}$"],
...
plot_defs[1][0] = {
    ...
    "y_data_list": [Pxx_E_north_sta_psd, Pxx_delta_B_E_sta_psd],
    "labels": [r"PSD of $\Delta_{B_{East}}$", r"PSD of $E_{North}$"],
...
plot_defs[1][1] = {
    ...
    "y_data_list": [Pxx_E_north_dy_psd, Pxx_delta_B_E_dy_psd],
    "labels": [r"PSD of $\Delta_{B_{East}}$", r"PSD of $E_{North}$"],
    "yscale": "log",  # Use log scale
    "title": "PSD of $\Delta_{B_{East}}$ and $E_{North}$",
    "xlabel": "Frequency (Hz)",
