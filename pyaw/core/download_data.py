...
class SwarmDownload:
    """
    download swarm data using vires
    """
    ...
    def download_orbit_collection(
        ...
        """
        Download 1 orbit of collection data as a DataFrame and save as '.pkl' file.
        ...
        if download_type is None:
            ...
            request.set_products(
                auxiliaries=configs.SwarmConfig.ViresSwarmRequest.auxiliaries
            )
        else:
