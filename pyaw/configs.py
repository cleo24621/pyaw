...
class DMSPConfigs:
    class SPDF:
        ...
        ssies3_orbit_time = timedelta(hours=1, minutes=45)  # little greater than the real orbit time
...
class Zh1Configs:
    ...
    indicator_descend_ascend_dict = {"0": "descending", "1": "ascending"}  # ascending (south to north); descending (north to south)